from numpy import ndarray, asarray, dot, cross, cov, array, finfo, min as npmin, max as npmax
...
class OBB:
    ...
    def build_from_points(cls, points):
        ...
        return OBB.build_from_covariance_matrix(cov(points, y=None, rowvar=False, bias=True), points)
